...
dataset_spacev1b_100m() {
  BASE_PATH=/users/gv2359/new_partition/SPTAG/datasets/SPACEV1B/vectors.bin/vectors_merged.bin
  QUERY_FILE=/users/gv2359/new_partition/SPTAG/datasets/SPACEV1B/query.bin
  GT_FILE=/users/gv2359/new_partition/SPTAG/datasets/SPACEV1B/gt_100m.bin
